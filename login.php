...
<html lang="en">
  <head>
    ...
    <title>SpaceAppChallenge - Login</title>
    <!-- Bootstrap -->
  ...
  <body>
    ...
    <div class="container mt-3">
        ...
        <h1 align="center">Sys Ally - Login</h1> <hr>
		
		<div class="row text-justify">
		<div class="container col-xl-4"> 
			<form method="post" action="process/process_login.php" id="formlogin" name="formlogin" class="form-signin">
        <label class="sr-only">User</label>
        <input type="text" name="email" id="login" class="form-control" placeholder="Email" required="" autofocus="">
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" name="password" id="senha" class="form-control" placeholder="Password" required="">
